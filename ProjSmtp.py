...
msg = '{}. \r\nHey I am having a Networks Project'.format(YOUR_BODY_EMAIL)
endmsg = '\r\n.\r\n'

# Choose a mail server (e.g. Google mail server) and call it mailserver
mailServer = 'smtp.gmail.com'
mailPort = 587 #Standard Secure Smtp  port 

# Create socket called clientSocket and establish a TCP connection with mailserver
#Fill in start
clientSocket = socket(AF_INET, SOCK_STREAM) #Adress Family Provides sequenced, two-way byte streams with a transmission mechanism for stream data. 
...
# Fill in start
strtlscmd = "STARTTLS\r\n".encode() #Transport Layer Security
clientSocket.send(strtlscmd)
recv2 = clientSocket.recv(1024)
# SSL: Secure Socket Layer
sslClientSocket = ssl.wrap_socket(clientSocket) #Add SSl to client Socket or server Server
